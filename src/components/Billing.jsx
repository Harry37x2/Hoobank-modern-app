...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
        <div className={layout.sectionImgReverse}>
            ...
            {/* <div className='absolute z-[3] -left-1/2 top-0 w-[50%] h-[50%] tounded-full white__gradient' />
            <div className='absolute z-[0] -left-1/2 bottom-0 w-[50%] h-[50%] tounded-full pink__gradient' /> */}
        </div>
